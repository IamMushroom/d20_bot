...
несовместим с новой схемой SQLite. Перед production-релизом с миграциями нужно создать
резервную копию `d20.sqlite3`; откатывать образ и базу следует вместе.
