...
Изменение состояния игры и создание связанного outbox-события выполняются одним application
use case внутри общей SQLite-транзакции. Ошибка записи события откатывает изменение сессии.
